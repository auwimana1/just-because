        ...
        stage("build an image and push it to ecr"){
            steps{
                script{
                    ...
                    withDockerRegistry(credentialsId: 'ecr:sa-east-1:Adelina_IAM', url: 'https://557195342730.dkr.ecr.us-east-1.amazonaws.com/') {
                    ...
                    sh "docker push 557195342730.dkr.ecr.us-east-1.amazonaws.com/just-because-ecr:${params.DevOps-Engineer}"
